...
import {getClothing, validatePotentialClothing, updateClothing, getStyles} from "./api/Storage.js";
...
class EditClothing extends React.Component {
  constructor(props) {
    super(props);
          ...
          <div>
            <nav class="breadcrumb" aria-label="breadcrumbs">
              <ul>
                ...
                <li class="is-active"><a aria-current="page">Edit Clothing</a></li>
              </ul>
            </nav>
          </div>
          <div class="columns">
...
export default withRouter(EditClothing);